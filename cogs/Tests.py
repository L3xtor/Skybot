...
cogs = Literal['cogs.Math', 'cogs.Tests', 'cogs.Responses', 'hypixel.catacombs.Catacombs', 'cogs.Level', 'hypixel.Emoji', 'hypixel.fishing.Fishing', 'hypixel.general.Skills', 'hypixel.general.Accountlinks']
